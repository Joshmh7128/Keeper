...
public class Node
{
    ...
    public Node Parent; //for the astar algorith, will store what node it previously came from so it can trace the shortest path
    ...
    public Node(bool a_IsWall, Vector3 a_Pos, int a_gridX, int a_gridY) //node constructor
    {
